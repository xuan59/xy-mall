...
export default {
  ...
  methods: {
    ...
    initWebSocket() {
      ...
      const wsurl = 'ws://192.168.43.179:8081/websocket/' + sid
  ...
  created() {
    ...
    // this.axios.post('/getAllMessage', params).then(data => {
    //     console.log(data)
    //     this.messageList = data.data
    // })
    // this.messageList.push('您好，我现在有事不在，一会再和您联系。')
    this.initWebSocket()
    var p = this
