<template>
  <div style="background-color: #f7f7f7;">
    <div>
      <van-nav-bar title="关于逍遥" left-text=" " left-arrow @click-left="onClickLeft" />
    </div>
    <van-index-bar :index-list="indexList">
      <van-cell title="检测更新" @click="jump('check')" >
      ...
      <van-cell title="当前版本" >
        <div class="personal_right">
          <el-link :underline="false" style="color:#c7c7c7;" v-text="version"></el-link>
        </div>
      </van-cell>
      <van-cell title="使用帮助" @click="jump('help')">
        <div class="personal_right">
          <van-icon name="arrow" />
        </div>
      </van-cell>
      <van-cell title="隐私政策" @click="jump('privacy')">
        <div class="personal_right">
          <van-icon name="arrow" />
        </div>
      </van-cell>
...
<van-overlay :show="helpShow" @click="helpShow = false">
  <div class="wrapper" @click.stop>
    <div class="block" >
        <van-nav-bar title="帮助" left-text=" " left-arrow @click-left="helpClose" />
        <p>遇到问题请联系客服</p>
 </div>
  </div>
</van-overlay>

  <van-overlay :show="privacyShow" @click="show = false">
  <div class="wrapper" @click.stop>
    <div class="block" >
      
        <van-nav-bar title="隐私政策" left-text=" " left-arrow @click-left="privacyClose" />
